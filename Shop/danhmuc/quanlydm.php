	...
	<div class="app">
		...
		<ul class="header__sort-bar">
			<li class="header__sort-item">
				<a href="" class="header__sort-link">DANH MỤC</a>
			</li>
		</ul>
			...
			<div class="grid wide">
				<div class="row sm-gutter grid-content">
					...
					<div class="column l-10 me-12 s-12">
						...
						<span class="label" style="margin-right: 16px;"><h2><a href="themdm.php" style="color: red;">Thêm danh mục</a></h2></span>					
						</div>
