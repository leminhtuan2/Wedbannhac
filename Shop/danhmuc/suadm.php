...
<div >
    ...
    <table >
    <tr><td>Tên danh mục:     <input type="text" name="tendanhmuc" value="<?php echo $thongtinsv['tendanhmuc']; ?>"></td>	</tr>
	<tr><td align="center">   <input type="submit" value="Sửa tên danh mục"></td>      </tr>
    </table>         
	</form>
	</div>
					</div>	
