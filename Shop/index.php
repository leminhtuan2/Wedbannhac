	...
	<div class="app">
		<div class="header">
			<div class="grid wide">
				<div class="header-main">
					<div class="logo">
					<a href="index.html"><img src="./img/logo2.jpg" width="200" height="110"></a>
					</div>
					<div class="search">
		...
		<div class="header-mobile">
			<div class="header-mb">
				...
				<a class="shopping-cart-mb" href="../Shop/pages/giohang.php">
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  				...
  				<div class="carousel-inner">
    				<div class="carousel-item active">
    					 <img class="d-block w-100 h-50 h-50" src="./img/banner.jpg" alt="First slide">
   					</div>
    				<div class="carousel-item">
      					<img class="d-block w-100 h-50" src="./img/banner2.jpg" alt="Second slide">
    				</div>
    				<div class="carousel-item">
     					<img class="d-block w-100 h-50" src="./img/banner3.jpg" alt="Third slide">
   					</div>
   					<div class="carousel-item">
     					<img class="d-block w-100 h-50" src="./img/banner2.jpg" alt="Fourth slide">
   					</div>
  				</div>
